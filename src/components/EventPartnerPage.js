...
import { fetchAssignedUsersEvents, getInstanceById } from "../data/data";
          ...
          <Row className="flex-center">
            <div className="d-flex">
              ...
              <div className="fs--1 ms-2 flex-1">
                <h2 className="fs-0 text-capitalize" style={{paddingTop:"30px"}}>
                {chosenEvent
                    ? chosenEvent.instanceAttributes.title + " - " + chosenEvent.instanceAttributes.genre 
                    : null} 
                </h2>
              </div>
            </div>
                ...
                />
                 <div className="flex-1 position-relative ps-3">
                  <h6 className="fs-0 mb-0">
                      <span className="me-1">{instance.instanceAttributes.firstName + " " + instance.instanceAttributes.lastName}</span>
