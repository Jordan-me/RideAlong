...
const MyProfile =() => {
  ...
  return(
    ...
    <div  className="mb-5" style ={{paddingTop:"138px"}}>
      <Container  style ={{marginLeft:"99.6px",paddingLeft:"12px",marginRight:"99.6px",paddingRight:"12px"}}>
        <Row>
          <Col className='lg-3 ms-lg-auto'>
            ...
            <Card className='border-0 shadow mb-6 mb-lg-0'>
              <CardHeader className='bg-gray-100 py-4 border-0 text-center' 
                          style ={{paddingTop:"24px",paddingBottom:"24px",paddingLeft:"19.2px",paddingRight:"19.2px"}}>
